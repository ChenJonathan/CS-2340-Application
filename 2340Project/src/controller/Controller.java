...
/**
 * Controller superclass. Can either change the current dialog or display a
 * dialog in a new screen.
 * 
...
public abstract class Controller {
	...
	protected Controller showScreen(String path) {
		try {
			...
			mainStage.setScene(
					new Scene(root, Main.primaryScreenBounds.getWidth(), Main.primaryScreenBounds.getHeight()));
