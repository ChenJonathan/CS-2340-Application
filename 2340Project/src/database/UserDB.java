...
public class UserDB {
	...
	private static Map<String, User> _userList = new HashMap<>();
	 ...
	 * 
	 * @param userList
	 *            given list to initialize our list with.
	 */
	 ...
	 * @return true if the user was added, false if another user had the same
	 *         name.
	 */
	public boolean addUser(User user) {
		/*
		 * for (String userName : _userList.keySet()) { boolean namesMatch =
		 * user.getName().equals(userName); if (namesMatch) { return false; //
