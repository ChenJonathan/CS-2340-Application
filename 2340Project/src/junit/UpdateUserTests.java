...
public class UpdateUserTests {
    ...
    public final void setup() {
        ...
        user = new User("Update Test User "
                + count, "Test", AuthorizationLevel.USER);
        instance.addUser(user);
        instance.authenticateUser(user.getName(), user.getPassword());
    }

    /**
     * Test if the update user works.
     */
    @Test
    ...
    /**
     * Test if the authorization level
     * gets updated.
     */
    @Test
    public final void testUpdateAuth() {
    ...
    /**
     * Test if the email gets updated.
     */
    @Test
    public final void testUpdateEmail() {
    ...
    /**
     * Test if the phone number was updated.
     */
    @Test
    public final void testUpdatePhone() {
    ...
    /**
     * Tests if the address was updated.
     */
    @Test
